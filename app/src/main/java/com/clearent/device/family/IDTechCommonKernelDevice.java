...
/**
 * This interface describes contracts for an IDT_Device, along with extending some supporting interfaces for Clearent.
 */
//TODO It is possible that some of these are actually specific to the IDT_VP3300 implementation. This should be apparent as we
//TODO introduce the rest of the family.
public interface IDTechCommonKernelDevice extends Configurable, HasTokenizingSupport, HasSwipeSupport {
