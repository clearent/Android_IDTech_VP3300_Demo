 ...
 *
 * I first started with VP3300. I 'optimistically' inherited its interface as a IDTechCommonKernelDevice interface
 *
 ...
 *
 * The goal is to use the IDTechCommonKernelDevice interface for our own benefit and still make the developer
 ...
 * 6 - use the IDE to implement any methods that are not in IDTechCommonKernelDevice.
